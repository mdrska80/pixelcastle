...
namespace Castles
{
    public class interfaceView : Drawable
    {
        ...
        public void init()
        {
            SpriteAnimated saCursor = new SpriteAnimated(Game.I.resourceManager.GetTexture("CURSOR"), 96, 96, 90, Game.I.window, RenderStates.Default,0,14,true);
        ...
        public void Draw(RenderTarget target, RenderStates states)
        {
            ...
            Sprite.CurrentSprite.Update((int)Game.I.delta / 1000);
        }
    }
}
